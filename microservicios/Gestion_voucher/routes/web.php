...
use App\Http\Controllers\BulkVoucherController;
...
Route::post('/validar-voucher', [Voucher_Controller::class, 'validarVoucher'])->name('validar.voucher');
    ...
    Route::get('validacion/vouchers/bulk', [BulkVoucherController::class, 'index'])->name('bulk.index');
    Route::post('validacion/vouchers/bulk/validate', [BulkVoucherController::class, 'validarTodos'])->name('bulk.validate');
